...
!function ($) {
	...
	$.fn.extend({
		showPassword: function (options) {
			...
			input_normal	= $('<input class="form-control" type="text">').val(input_password.val()).hide();

			// Create the icon and assign
			icon_password = $('<span tabindex="100" title="' + settings.message + '" class="input-group-addon"><i class="fa fa-eye' + icon_white + '"></i></span>').css('cursor', 'pointer');
